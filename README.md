...
## 📌 Resumen final  
<p align="justify">
El presente README describe la conformación del equipo, la problemática abordada y la propuesta de solución desarrollada en el curso Fundamentos de Diseño. El proyecto consiste en el desarrollo de un sistema inteligente para la detección y análisis de microplásticos en playas y humedales de Lima, mediante la recolección de muestras y su procesamiento con visión artificial e inteligencia artificial. Esta solución permite automatizar un proceso tradicionalmente manual, generando datos confiables para el monitoreo ambiental y contribuyendo a la protección de los ecosistemas acuáticos.
</p>